...
P1 观测配比在 λ=1 下预测改善 0.4973；λ 随 N 衰减时收益按情景降低，尚无跨尺度联合识别。Loose 配比的支持等级：in-support。
...
联合 bootstrap 的 Q=1 稳定率：1e+19:0.0%; 1e+20:10.5%; 1e+22:100.0%; 1e+24:100.0%。理论弹性 eN=0.4515、eD=0.5485。E1 3× 下的 minimax regret 解是一种条件方案；上限剖面显示高预算结果对边界敏感，因此不给唯一规模推荐。
