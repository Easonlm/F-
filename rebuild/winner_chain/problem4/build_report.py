...
"""
    ...
    selected_mix = pd.read_csv(ROOT / "problem3_v2/outputs/tables/mixture_support_diagnostics.csv")
    selected_p1_delta = float(selected_mix.loc[selected_mix.strategy == "P1_observed_support", "delta_p"].iloc[0])
    final={"problem1":{"quality_proxy":"four-group index; no independent human gold standard","mixture":"P1 observed support","p1_delta_loss":selected_p1_delta},
