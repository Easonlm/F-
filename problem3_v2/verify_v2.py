...
def run():
    ...
    required=['lambda_p_extended_sensitivity.csv','lambda_p_scale_scenarios.csv','mixture_support_diagnostics.csv','quality_transition_points_exact.csv',
              ...
              'extrapolation_levels.csv','soft_extrapolation_penalty.csv','robust_optimization.csv','resource_consensus.csv','kkt_diagnostics.csv',
